                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            ...
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Season_1_key_visual_clean_version.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                ...
                                                on Titan</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">25 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px; background-image:url('{{asset('other/Season_2.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                ...
                                                2</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">12 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Season_3.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Attack_on_Titan_Season_3_sixth_key_visual_clean.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack
                                                on Titan Season 3 Part 2</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">10 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Attack_on_Titan_The_Final_Season_Part_1_clean_version.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack
                                                on Titan The Final Season</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">16 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Attack_on_Titan_The_Final_Season_Part_2_Key_Visual_8with_logo.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack
                                                on Titan The Final Season Part 2</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">12 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Final_Season_Part_3_teaser_textless.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1"></span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Attack_on_Titan_OAD_Archive_cover.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <a href="#"
                                                ...
                                                on Titan OAD</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">8 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Movie_1_textless_poster.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack on Titan Part I: Crimson Bow and Arrow</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">1 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Movie_2_poster_2.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack on Titan Part II: Wings of Freedom</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">1 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Movie_3_textless_poster.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack on Titan: The Roar of Awakening</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">1 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0 mb-lg-10">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                style="height: 266px;background-image:url('{{asset('other/Movie_4_textless_poster.webp')}}')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 text-hover-primary fs-3 fw-bolder d-block mb-2">Attack on Titan ~Chronicle~</a>
                                            <!--end::Title-->
                                            <span class="fw-bolder fs-6 text-gray-400 d-block lh-1">2 Episodes</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Player card-->
