        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-xl-12">
                ...
                <div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                    style="background-color:#020202;background-image:url('{{asset('other/Attack_on_Titan_Season_1.webp')}}'),linear-gradient(90deg, rgba(15,49,75,1) 0%, rgba(45,51,103,1) 100%);">
                    <!--begin::Body-->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-11 pt-xl-13">
                                    <!--begin::Title-->
                                    <h3 class="fw-bolder text-white fs-4x mb-0 ms-n1">Attack On Titan</h3>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center me-6">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <span class="fw-bold text-white fs-6">25 Episodes</span>
                                            <!--end::Info-->
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="card-body">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">April 7, 2013</div>
                            <!--end::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bolder mt-5 ">Albums Released for this Season</div>
                            <div class="text-gray-600">
                                Attack on titan Orginal Soundtrack</div>
                                <div class="text-gray-600">
                                    Attack on titan Orginal Soundtrack II</div>
                            <!--end::Details item-->
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-flush h-xl-100">
                    {{-- <div class="card-header">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">Episodes</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                        ...
                        {{-- <div class="d-flex flex-column flex-md-row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="kt_vtab_pane_3" role="tabpanel">Sint sit mollit irure
                                    ...
                                    commodo
                                    veniam Lorem aliquip laborum occaecat qui Lorem esse mollit dolore anim cupidatat.
                                    eserunt officia id Lorem nostrud aute id commodo elit eiusmod enim irure amet
                                    eiusmod
                                    qui reprehenderit nostrud tempor. Fugiat ipsum excepteur in aliqua non et quis
                                    aliquip
                                    ad irure in labore cillum elit enim. Consequat aliquip incididunt ipsum et minim
                                    laborum
                                    laborum laborum et cillum labore. Deserunt adipisicing cillum id nulla minim nostrud
                                    labore eiusmod et amet.</div>
                            </div>
                        </div> --}}
                        {{-- <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="#kt_vtab_episode_1" role="tabpanel">--}}
                                <div class="">
                                    <div class="d-flex flex-column flex-md-row rounded">
                                        <ul
                                            ...
                                            <li class="nav-item w-100px  me-0">
                                                <a class="nav-link active btn btn-sm btn-active-light-primary"
                                                targ = "1"
                                                    data-bs-toggle="tab" href="#kt_vtab_pane_1">Episode 1</a>
                                            </li>
                                            <li class="nav-item w-100px me-0">
                                                <a class="nav-link btn btn-sm btn-active-light-primary"
                                                    targ = "2"
                                                    data-bs-toggle="tab" href="#kt_vtab_pane_1">Episode 2</a>
                                            </li>
                                            <li class="nav-item w-100px">
                                                <a class="nav-link btn btn-sm btn-active-light-primary"
                                                targ = "3"
                                                    data-bs-toggle="tab" href="#kt_vtab_pane_1">Episode 3</a>
                                            </li>
                                        </ul>
...
<script>
    ...
    //     abc = $('#kt_datatable_example_3').DataTable({
    //          responsive: true,
    //          ScrollY:500,
    //          paging: false,
    //          info:false,
