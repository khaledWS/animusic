        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                ...
                <form id="kt_ecommerce_settings_general_form" class="form" method="POST"
                    action="{{ route('album.create') }}" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <!--begin::Input group-->
                    <div class="mb-7">
                        <!--begin::Image input-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select value="{{ old('title_id') }}" name="title_id" aria-label="Select a title"
                            ...
                            @isset($titles)
                                @foreach ($titles as $title)
                                    <option value="{{ $title->id }}"
                                        {{ old('title_id') == $title->id ? 'selected' : '' }}>
                                        {{ $title->title }}</option>
                                @endforeach
                            @endisset
                        </select>
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="composer[]" aria-label="Select a title"
                                    data-minimum-results-for-search="Infinity" multiple="multiple" data-control="select2"
                                    data-placeholder="Select title" class="form-select form-select-solid"
                                    value="{{ old('composer[]') }}">
                                    <option value=""></option>
                                    @foreach ($composers as $composer)
                                        <option @selected(old('composer') == $composer->id) value="{{ $composer->id }}">
