                ...
                <div class="row mb-7">
                    ...
                    <div class="col-md-1">
                        ...
                        <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input" name="unknown" isChecked="false" type="checkbox" value="" />
                        </label>
                        <!--end::Option-->
                    </div>
                    <div class="col-md-1">
                        ...
                        <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input" name="new" isChecked="false" type="checkbox" value="" />
                        </label>
                        <!--end::Option-->
                    </div>
