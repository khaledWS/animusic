...
var KTDocsDatatableSubtable = function () {
    ...
    const populateTemplate = (data, target) => {
        ...
        data.forEach((d, index) => {
            ...
            const start = newTemplate.querySelector('[data-kt-docs-datatable-subtable="template_start"]');
            const end = newTemplate.querySelector('[data-kt-docs-datatable-subtable="template_end"]');
            ...
            if (data.length === 1) {
                ...
                newTemplate.querySelectorAll('td')[3].classList.add(...borderClasses);
